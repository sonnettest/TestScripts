...
public class CreateRFQ extends SonnetElement {
	...
	public void acquentLogin() {
		findElement(By.name("USERNAME")).sendKeys("OU90J36");
		findElement(By.name("PASSWORD")).sendKeys("jdsn2w8e");
...
*/
		...
		findElement(By.xpath("(//*[@class='tbl']//tr[3]/td[2])[1]/input"))
				.sendKeys("RFQ description");// RFQDescription
		...
		findElement(By.xpath("//*[@class='tbl']//tr[5]/td[2]/select"))
				.selectByVisibleText("Antartica Funny Money");
...
*/		findElement(By.xpath("//*[@href='create_rfq_parts.asp']")).click();// click
	...
	public void entermainpartdetails() {
		...
		findElement(
				By.cssSelector("	 .altRow:nth-child(1)>td:nth-child(8)>input"))
				.sendKeys("someMOQ");
	...
	public void pricebreaks() {
		findElement(
				By.xpath("//*[@class='alternateRows']//tbody//tr[1]/td[8]//a"))
				.click();
		findElement(
				By.xpath("//*[@id='TB_ajaxContent']//*[@class='tbl']//tr[1]//input"))
				.sendKeys("12");
		findElement(
				By.xpath("//*[@id='TB_ajaxContent']//*[@class='tbl']//tr[2]//input"))
				.sendKeys("22");
		findElement(
				By.xpath("//*[@id='TB_ajaxContent']//*[@class='tbl']//tr[3]//input"))
				.sendKeys("32");
		findElement(By.xpath("//*[@id='TB_closeWindowButton']")).click();
	}

	public void monthly() {
		findElement(
				By.cssSelector(":nth-child(1)>td:nth-child(7)>a[title='Monthly EAU']"))
				.click();
